...
pub fn verify_presigned(
    ...
    let identity: Identity = Credentials::new(
        &parsed.access_key, secret, None, None, "openlake-config",
    ).into();
...
pub fn verify_chunk(
    ...
    let identity: Identity = Credentials::new(
        access_key, secret, None, None, "openlake-config",
    ).into();
...
mod tests {
    ...
    fn seed_round_trips_with_unsigned_payload() {
        ...
        let identity: Identity = Credentials::new(
            "AKIAOPENLAKE", "secretsecretsecret", None, None, "test",
        ).into();
        let settings = s3_signing_settings();
        let params = v4::SigningParams::builder()
    ...
    fn presigned_round_trip_get() {
        ...
        let uri_str = presign(
            ...
            "AKIAOPENLAKE", "secretsecretsecret",
